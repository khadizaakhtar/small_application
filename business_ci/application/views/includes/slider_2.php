                            ...
                            <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 1300px; height: 200px; overflow: hidden;">
                                <div class="slid" data-p="225.00" style="display: none;">
                                    ...
                                    <ul class="kcatp">
                                        ...
                                        foreach($slider_category as $k_category){
                                        ?> 
                                        <li><a href="<?php echo base_url();?>show_company/highestrate/<?php echo $k_category->category_id;?>"><?php echo $k_category->category_name;?></a></li>
                                      <?php } ?>
                                    </ul>
                                ...
                                <div  class="slid" data-p="225.00" style="display: none;">
                                    ...
                                    <ul class="kcatp2">
                                        ...
                                        foreach($slider_category2 as $k_category2){
                                        ?> 
                                      <li><a href="<?php echo base_url();?>/show_company/highestrate/<?php echo $k_category2->category_id;?>"><?php echo $k_category2->category_name;?></a></li>
                                      <?php } ?>
                                    </ul>
                                </div>                               
                            </div>
