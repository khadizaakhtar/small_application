    ...
    <div class="container">
        <div class="content_middle_box">
            <?php //foreach($company_detail as $detail) { 
             $company_image = $this->user_model->get_company_main_image($company_detail->company_id); 
?>
            <div class="top_grid">
                <div class="col-md-12">
...
<img src="<?php echo base_url() . "multi_img/" . $company_image->images; ?>" style="width:100%;height:365px;" alt=""/>
 <?php } else{?>
                            ...
                            <div class="col-md-12" style="background-color:white; padding-bottom:10px; margin-bottom: 15px;">
                                ...
                                <ul class="website parent-container">
                                    ...
                                    <li><?php
                                        ...
                                        echo date('M-d-Y', strtotime($rev->create_time));
                                        ?></li><span>.</span>
