<div class="content_middle">
    <div class="container">
		...
		<?php foreach($company_detail as $detail) { ?>
            <div class="top_grid">
                <div class="col-md-12">
                    <p><h3><?php echo $detail->company_name;?></h3></p>
                </div>
            </div>
            <div class="top_grid">
                <div class="col-md-8">
                    <div class="grid1">
                        <div class="index_img parent-container"><a href="<?php echo base_url().'images/pic4.jpg'?>"><img src="<?php echo base_url() . "uploads/" . $detail->company_logo; ?>" style="width:100%;height:365px;" alt=""/></a></div>
                    </div>
                    <div class="inner_wrap1">
                        <ul class="item_module">
                            <li class="module_left" style="padding:0 0 15px 0 !important"><p>Review</p></li>
                ...
                <div class="col-md-4">
                    <div class="grid1">
                        ...
                        <div class="inner_wrap1 my_wrap1_address">
                            ...
                            <ul class="website">
							  <?php if($detail->company_website !=''){ ?>
                                <li><img src="<?php echo base_url();?>images/globe.ico" class="img-responsive" alt=""/></li>
                                <li><a href="<?php echo $detail->company_website;?>">website</a></li>
						      <?php } ?>	
                              <?php if($detail->facebook_link !=''){ ?>							  
                                <li><img src="<?php echo base_url();?>images/favicon.ico" class="img-responsive" alt=""/></li>
                                <li><a href="<?php echo $detail->facebook_link;?>">facebook</a></li>
						      <?php }?>
	                          <?php if($detail->twitter_link !=''){ ?>		
                                <li><img src="<?php echo base_url();?>images/favicont.ico" class="img-responsive" alt=""/></li>
                                <li><a href="<?php echo $detail->twitter_link;?>">twitter</a></li>
						      <?php } ?>		
                                <div class="clearfix"> </div>
                            </ul>
                        </div>
                    ...
                    <div class="grid1 image_grid1">
                        <div class="col-md-12" style="background-color:white;">
                            ...
                            <ul class="website parent-container">
                                <li><a href="<?php echo base_url().'images/e1.jpg'?>"><img src="<?php echo base_url().'images/e1.jpg'?>" class="img-responsive featured-img" alt=""/></a></li>
                                <div class="clearfix"> </div>
                            </ul>
                        </div>                       
                    </div> <hr>			
        ...
        <script>
            function initialize() {
                var myLatLng = {lat: 23.42407, lng: 53.847818};
