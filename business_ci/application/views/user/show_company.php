<?php 
 $url = base_url() . 'show_company/'.'highestrate/'.$this->uri->segment(3);
 $url_alpha = base_url() . 'show_company/'.'alfabetically/'.$this->uri->segment(3);
 $url_recent = base_url() . 'show_company/'.'recentfirst/'.$this->uri->segment(3);
                            ...
                            <ul class="results-sort cat-check pull-right">
                                <li>
                                   <input type="radio" value="Alphabetically" name="filterrific[sorted_by]" id="Alphabetically">
                                    <label for="Alphabetically" id="Alphabetically"> <a href="<?php echo $url_alpha?>">Alphabetically</a></label>
                                </li>
                                <li>
                                    <input type="radio" value="Recent First" name="filterrific[sorted_by]" id="Recent First">
                                    <label for="Recent First" id="RecentFirst"><a href="<?php echo $url_recent?>">Recent First</a></label>
                                </li>
                                <li>                           
                                    <input type="radio" value="Highest Rated" name="filterrific[sorted_by]" id="Highest Rated">
                                    <label for="Highest Rated" id="HighestRated"><a href="<?php echo $url;?>">Highest Rated</a></label>
                                </li>
                            </ul>
                        </div>	
                    </div>
