    ...
    <div class="span6">
        ...
        <div class="widget green">
            ...
            <div class="widget-body form">
                ...
                <form  method="post" action="<?php echo base_url(); ?>save_spot" enctype="multipart/form-data">
                            ...
                            <div class="widget red">
                                ...
                                <div class="widget-body form">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea class="span12 wysihtmleditor5" name="spot_description" rows="5"></textarea>
                                        </div>
                                    </div>
