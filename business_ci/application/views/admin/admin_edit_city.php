    ...
    <div class="span6">
        ...
        <div class="widget green">
            ...
            <div class="widget-body form">
                ...
                <form  method="post" action="<?php echo base_url(); ?>update_city/<?php echo $result->city_id; ?>">
                    <div class="control-group">
                        <label class="control-label">City Name</label>
                        <div class="controls title">
                            <input type="text" class="title" name="city_name" value="<?php echo $result->city_name; ?>" id="category_name">
                        </div>
                    </div>
