                    ...
                    <tbody>
                        ...
                        foreach ($all_company as $v_result) {
                            ...
                            <tr>
                                ...
                                ?></td>
                                <td><?php if($v_result->status == 0){?>
                                    <a href="<?php echo base_url();?>company_verification/<?php echo $v_result->company_id;?>/<?php echo $v_result->status?>"><?php echo 'Verified' ?></a>
                                <?php } if($v_result->status == 1){?>
                                    <a href="<?php echo base_url();?>company_verification/<?php echo $v_result->company_id;?>/<?php echo $v_result->status?>"><?php echo 'Not Verified' ?></a>
                                <?php }if($v_result->status == 2){?>
                                    <?php echo 'Banned' ?>
                                <?php }?>
                                </td>
                                <td> 
