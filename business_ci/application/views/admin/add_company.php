        ...
        <div class="widget green">
            ...
            <div class="widget-body">
                ...
                <form  method="post" action="<?php echo base_url(); ?>save_company" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        <div class="controls title">
                            <textarea name="company_address" rows="4" cols="30" placeholder="Company address"><?php echo set_value('company_address');?></textarea>
                            <span class="required-field company_address" style="color:red">*</span>
                        </div>
                    </div>
