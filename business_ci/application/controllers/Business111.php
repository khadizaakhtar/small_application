...
class Business extends CI_Controller {
    ...
    public function admin_save_company() {
        ...
        //echo $this->input->post('sub_category_id'); exit;
    ...
    public function update_company() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data['sub_category_id'] = $this->input->post('sub_category_name', true);
    ...
    public function list_a_business() {
        ...
        if ($this->form_validation->run() == FALSE) {       // echo 123; exit;
            ...
            $company['company_website'] = $this->input->post('company_uri');
            $company['facebook_link'] = $this->input->post('facebook_uri');
            $company['twitter_link'] = $this->input->post('twitter_uri');
